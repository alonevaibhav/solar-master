...
class TokenManager {
  ...
  static void _navigateByRole(String role) {
    ...
    switch (role.toLowerCase()) {
      case 'cleaner':
        targetRoute = '/cleaner/dashboard';
        break;
      case 'inspector':
        targetRoute = '/inspector/dashboard';
        break;
      case 'user':
        targetRoute = '/user/home';
        break;
      default:
        print('Unknown role: $role, defaulting to cleaner dashboard');
        targetRoute = '/cleaner/dashboard'; // Default route
        break;
    }
