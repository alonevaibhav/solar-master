                ...
                child: Row(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.wb_sunny,
                            color: Colors.amber[300], size: 28.r),
                        SizedBox(width: 8.w),
                        Text(
                          'Solar Schedule',
                          style: TextStyle(
                            ...
                            child: Column(
                              children: [
                                _buildSolarScheduleTile(
                                  title: 'Automatic Schedule',
                                  description:
                                      'Set it once and let the system manage everything for you',
                                  icon: Icons.auto_awesome,
                                  gradientColors: [
                                    Color(0xFF3B82F6),
                                    Color(0xFF1D4ED8)
                                ...
                                _buildSolarScheduleTile(
                                  title: 'Manual Schedule',
                                  description:
                                      'Customize your cleaning schedule manually',
                                  icon: Icons.edit_calendar,
                                  gradientColors: [
                                    Color(0xFF3B82F6),
                                    Color(0xFF1D4ED8)
                                ...
                                _buildSolarScheduleTile(
                                  title: 'Timing Slots',
                                  description:
                                      'Configure and view your maintenance time slots',
                                  icon: Icons.schedule,
                                  gradientColors: [
                                    Color(0xFF3B82F6),
                                    Color(0xFF1D4ED8)
                                ...
                                _buildSolarScheduleTile(
                                  ...
                                  description:
                                      'Review past cleaning sessions and performance metrics',
                                  ...
                                  accentColor: Color(0xFF60A5FA),
                                  onTap: () {
                                    Get.toNamed(AppRoutes.historyInspector,
                                        arguments: plantData);
                                  },
                                ),
                              ],
