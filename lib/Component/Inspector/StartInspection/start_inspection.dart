...
//     // controller = Get.put(PlantInspectionController(), tag: controllerTag!);
//     controller = Get.put(PlantInspectionController(), tag: controllerTag!, permanent: true);
//
//
//     // Use addPostFrameCallback to ensure the widget tree is fully built
//     WidgetsBinding.instance.addPostFrameCallback((_) {
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 8 * 0.9.h),
                      LinearProgressIndicator(
                        value: plantInspectionController.checklistItems.where((item) => item['checked'] == 1).length / plantInspectionController.checklistItems.length,
                        backgroundColor: Colors.grey[200],
                        valueColor: AlwaysStoppedAnimation<Color>(Colors.blue),
                        minHeight: 6 * 0.9.h,
                      ),
                                ...
                                children: [
                                  ...
                                  if (item['info'] != null) ...[
                                    ...
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: _getTypeColor(item['info']).withOpacity(0.1),
                                        borderRadius: BorderRadius.circular(12 * 0.9.r),
                                        border: Border.all(
                                          color: _getTypeColor(item['info']).withOpacity(0.3),
                                          width: 1,
                                        ),
                                      ),
                                      child: Text(
