...
//   final rtcTime = 0.obs; // Parameter 560
//   final floot = 0.obs;   // Parameter 595
//   final pressure = 0.obs; // Parameter 596
//
//   @override
//   void onInit() {
//     super.onInit();
...
//         print('🕒 RTC Time (560): ${rtcTime.value}');
//       }
//
...
//       }
//
//       // Update parameter 595 (Floot)
//       if (595 < allParameters.length) {
//         floot.value = allParameters[595];
//         print('🌊 Floot (595): ${floot.value}');
//       }
//
//       // Update parameter 596 (Pressure)
//       if (596 < allParameters.length) {
//         pressure.value = allParameters[596];
//         print('🔘 Pressure (596): ${pressure.value}');
//       }
//
...
//       print('📊 Additional Parameters - RTC: ${rtcTime.value}, Floot: ${floot.value}, Pressure: ${pressure.value}');
//     } catch (e) {
