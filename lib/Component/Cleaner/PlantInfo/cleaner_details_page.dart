...
class CleanerDetailsPage extends StatelessWidget {
              ...
              child: Column(
                children: [
                  ...
                  if (plantData['info'] != null &&
                      plantData['info'].toString().isNotEmpty) ...[
                    SizedBox(height: 20.h),
                    _buildAdditionalInfo(plantData),
                  ],
                  // SizedBox(height: 32.h),
  ...
  Widget _buildNavigatableStatCard(
  ...
  Widget _buildSolarHealthSection(InfoPlantCleanerDetailController controller) {
    return Container(
  ...
  Widget _buildSolarHealthStatsRow(
      InfoPlantCleanerDetailController controller) {
    return Row(
      children: [
        Expanded(
...
// New method to build critical status messages
  Widget _buildCriticalStatusMessages(
      InfoPlantCleanerDetailController controller) {
  ...
  Widget _buildRtcTimeRow(InfoPlantCleanerDetailController controller) {
