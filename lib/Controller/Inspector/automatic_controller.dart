...
//       }
//
//       // Update only parameters 50-99 from the parsed data, but only up to the number of boxes
//       // Each box has 1 parameter (50 = box 1, 51 = box 2, etc.)
//       final maxParameterToShow = 49 + numberOfBoxes.value;
//       for (int i = 50; i < 100; i++) {
//         if (parameterValues.containsKey(i) && i < allParameters.length) {
//           // Only update if this parameter is for a valid box
//           if (i <= maxParameterToShow) {
//             parameterValues[i]!.value = allParameters[i];
//           } else {
//             // For boxes beyond the count, set to 0
...
//                 .where((e) => e.key <= maxParameterToShow) // Only include parameters for valid boxes
...
//       print('Box parameters values:');
//       for (int i = 50; i < 50 + numberOfBoxes.value; i++) {
//         if (parameterValues.containsKey(i)) {
//           print('    Box ${i-49} (Parameter $i) = ${parameterValues[i]!.value}');
//         }
//       }
//
//     } catch (e) {
...
//     if (parameterValues.containsKey(index) && index <= (49 + numberOfBoxes.value)) {
//       // Validation
...
//         'parameters': Map.fromEntries(
//             parameterValues.entries
//                 .where((e) => e.key <= (49 + numberOfBoxes.value))
//                 .map((e) => MapEntry(e.key.toString(), e.value.value))
//         ),
